...
print(f'Calling Function that returns boolean runs in : {test_function_returns_boolean()} seconds')
print(f'Calling boolean Variable runs in : {test_boolean_variable()} seconds')
print(f'Calling Function that returns int runs in : {test_function_returns_int()} seconds')
print(f'Calling int Variable runs in : {test_int_variable()} seconds')
print(f'Calling Function that returns float runs in : {test_function_returns_float()} seconds')
print(f'Calling float Variable runs in : {test_float_variable()} seconds')
print(f'Calling Function that returns string runs in : {test_function_returns_string()} seconds')
print(f'Calling string Variable runs in : {test_string_variable()} seconds')
print(f'Calling Function that returns tuple runs in : {test_function_returns_tuple()} seconds')
print(f'Calling tuple Variable runs in : {test_tuple_variable()} seconds')
print(f'Calling Function that returns list runs in : {test_function_returns_list()} seconds')
print(f'Calling list Variable runs in : {test_list_variable()} seconds')
print(f'Calling Function that returns set runs in : {test_function_returns_set()} seconds')
...
print(f'Calling dictionary Variable runs in : {test_dictionary_variable()} seconds')
